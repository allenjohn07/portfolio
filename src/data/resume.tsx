...
export const DATA = {
  ...
  projects: [
    {
      title: "Cubing Kerala",
      href: "https://cubingkerala.vercel.app/",
      dates: "June 2024 - July 2024",
      active: true,
      description:
        "As an active member of the cubing community in Kerala, I developed this web application to assist cubers in tracking upcoming and past competitions, along with their rankings. This project was made possible with the support of Robin Ingelbrecht's REST API, which provides the necessary data to keep the community informed and engaged.",
      technologies: [
        "React",
        "Javascript",
        "Tailwind",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/allenjohn07/cubingkerala",
